...
public abstract class FileUtils {
    ...
    public static void writeFile(java.io.File file, ArrayList<String> lines) throws IOException {
        makeDirectories(file.getAbsolutePath().replace(file.getName(), ""));
        writeFile(file, lines.toArray(new String[0]));
    }

    public static void writeFile(java.io.File file, String[] lines) throws IOException {
        makeDirectories(file.getAbsolutePath().replace(file.getName(), ""));
    ...
    public static void writeFile(java.io.File file, String line) throws IOException {
        makeDirectories(file.getAbsolutePath().replace(file.getName(), ""));
        BufferedWriter outputWriter;
        outputWriter = new BufferedWriter(new FileWriter(file));
        outputWriter.write(line);
    ...
    public static String[] readFileToStringArray(java.io.File file) throws IOException {
        try {
            return Files.readAllLines(file.toPath()).toArray(new String[0]);
        } catch (Exception e) {
            return readFileFallback(file).toArray(new String[0]);
        }
    }

    public static ArrayList<String> readFileToArrayList(java.io.File file) throws IOException {
        try {
    ...
    private static ArrayList<String> readFileFallback(java.io.File file) throws IOException {
    ...
    public static void writeFileFromByteArray(java.io.File file, byte[] array) throws IOException {
        FileOutputStream fos = new FileOutputStream(file);
        fos.write(array);
        fos.close();
    }

    public static void copyFile(java.io.File sourceFile, java.io.File destinationFile) throws IOException {
        Files.copy(sourceFile.toPath(), (destinationFile).toPath(), StandardCopyOption.REPLACE_EXISTING);
    }

    public static void copyDirectory(java.io.File sourceDirectoryLocation, java.io.File destinationDirectoryLocation) throws IOException {
    ...
    public static boolean deleteFilesInDirectory(java.io.File directory) {
    ...
    public static boolean directoryExists(java.io.File directory) {
     ...
     */
    public static void openFile(java.io.File file, java.io.File workingDirectory) throws IOException {
        ProcessBuilder pb = new ProcessBuilder(file.getAbsoluteFile().toString());
        pb.directory(workingDirectory.getAbsoluteFile());
        pb.start();
    }

    public static void openFileUsingProcessBuilder(java.io.File file) throws IOException {
        ProcessBuilder pb = new ProcessBuilder(file.getAbsolutePath());
        pb.start();
    }

    public static boolean openFile(java.io.File file) throws IOException {
    ...
    public static void openJar(String jar, String path, String[] args) throws IOException {
        java.io.File pathToExecutable = new java.io.File(jar);
        ...
        builder.directory(new java.io.File(path).getAbsoluteFile());
        builder.redirectErrorStream(true);
        builder.start();
    }

    public static void pack(java.io.File sourceDirPath, java.io.File zipFilePath) throws IOException {
    ...
    public static void unpack(java.io.File zipFile, java.io.File destination) throws IOException {
        byte[] buffer = new byte[1024];
        ZipInputStream zis = new ZipInputStream(new FileInputStream(zipFile));
        ZipEntry zipEntry = zis.getNextEntry();
        while (zipEntry != null) {
            java.io.File newFile = newUnZipFile(destination, zipEntry);
    ...
    private static java.io.File newUnZipFile(java.io.File destinationDir, ZipEntry zipEntry) throws IOException {
    ...
    public static boolean isArchive(java.io.File file) throws IOException {
        int fileSignature = 0;
    ...
    public static long fileSize(java.io.File file) {
        return file.length();
    }
    ...
    public static ArrayList<java.io.File> getFiles(java.io.File directory) {
        ArrayList<java.io.File> foundFiles = new ArrayList<>();
        return getFiles(directory, "", foundFiles);
    }

    public static ArrayList<java.io.File> getFiles(java.io.File directory, String ending) {
        ArrayList<java.io.File> foundFiles = new ArrayList<>();
        return getFiles(directory, ending, foundFiles);
    }

    private static ArrayList<java.io.File> getFiles(java.io.File directory, String ending, ArrayList<java.io.File> foundFiles) {
        if (directory.isDirectory()) {
            java.io.File[] found = directory.listFiles();
    ...
    public static java.io.File javaFilePicker() {
    ...
    public static java.io.File[] windowsFilePicker() {
    ...
    public static String[] getResponseURL(String url) throws IOException {
        ...
        request.connect();
        Object o = request.getContent();
        if (o instanceof InputStream) {
            BufferedReader read = new BufferedReader(new InputStreamReader((InputStream) o));
            String i;
            while ((i = read.readLine()) != null)
                lines.add(i);
            read.close();
    ...
    public static void downloadFile(java.io.File file, String url) throws IOException {
        downloadFile(file, new URL(url));
    }

    public static void downloadFile(java.io.File file, URL url) throws IOException {
    ...
    public static Font getFont(java.io.File file) throws IOException, FontFormatException {
    ...
    public static void addWatchFile(java.io.File file, int period, FileWatcher fileWatcher) {
    ...
    public static void removeWatchFile(java.io.File file) {
        if (!watchFiles.containsKey(file.getAbsolutePath())) return;
    ...
    public static void setLastModified(java.io.File file, long time) throws IOException {
